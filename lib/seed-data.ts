...
export interface Club {
  ...
  founded: string;
  description: string;
  banner: string; // gradient token, always present, used as the background under photo (or alone as a fallback)
  photo?: string; // real theme-relevant photo; optional — falls back to the banner gradient when absent
}

// Per-club banner as a local CSS gradient keyed off the club's own accent hue —
// no external image request, so it paints instantly instead of depending on a
// third-party photo host (which was also serving explicitly uncacheable
// responses, forcing a slow refetch on every single page load).
function clubGradient(hue: string): string {
  return `linear-gradient(135deg, oklch(0.32 0.09 ${hue}) 0%, oklch(0.15 0.04 ${hue}) 100%)`;
}

export const clubs: Club[] = [
  { id: "c1", slug: "codechef", name: "CodeChef IITM BS", tagline: "Competitive programming, weekly contests.", category: "Technical", members: 412, active: true, hue: "122", emoji: "◉", lastEvent: "2 days ago", founded: "2021", description: "Weekly cook-offs, algorithm deep-dives, and interview prep circles. Home for anyone who thinks in edge cases.", banner: clubGradient("122") },
  { id: "c2", slug: "paradox", name: "Paradox - Debate Society", tagline: "Parliamentary debate & MUN circuit.", category: "Literary", members: 186, active: true, hue: "5", emoji: "❋", lastEvent: "5 days ago", founded: "2020", description: "British Parliamentary, Asians, and MUN training. Weekly practice rounds. Traveling squad.", banner: clubGradient("5") },
  { id: "c3", slug: "sarga", name: "Sarga - Music Circle", tagline: "Fusion, jams, semester showcases.", category: "Cultural", members: 234, active: true, hue: "260", emoji: "♪", lastEvent: "1 week ago", founded: "2019", description: "Instrumentalists, vocalists, producers. Open jam every Friday, big fusion show every semester.", banner: clubGradient("260") },
  { id: "c4", slug: "kalakriti", name: "Kalakriti Design Guild", tagline: "Product, UI, illustration critique.", category: "Design", members: 98, active: true, hue: "85", emoji: "◐", lastEvent: "3 days ago", founded: "2022", description: "Portfolio reviews, Figma workshops, brand studies. Cross-pollination with product & marketing.", banner: clubGradient("85") },
  { id: "c5", slug: "prakriti", name: "Prakriti - Sustainability", tagline: "Campus greening & climate action.", category: "Social", members: 156, active: true, hue: "155", emoji: "❦", lastEvent: "4 days ago", founded: "2021", description: "Zero-waste campaigns, tree drives, and climate literacy workshops for local schools.", banner: clubGradient("155") },
  { id: "c6", slug: "e-cell", name: "E-Cell IITM BS", tagline: "Founder circles & startup weekends.", category: "Entrepreneurship", members: 289, active: true, hue: "45", emoji: "◈", lastEvent: "Yesterday", founded: "2019", description: "Pitch nights, mentor office hours, and the annual Ignite startup weekend. Alumni founder network.", banner: clubGradient("45") },
  { id: "c7", slug: "quill", name: "Quill - Writers' Circle", tagline: "Prose, poetry, longform criticism.", category: "Literary", members: 74, active: false, hue: "320", emoji: "✦", lastEvent: "3 weeks ago", founded: "2022", description: "Monthly zine, workshop rounds, and reading nights. Fiction, poetry, essays, all welcome.", banner: clubGradient("320") },
  { id: "c8", slug: "arena", name: "Arena - Chess Club", tagline: "Blitz, bullet, and team leagues.", category: "Sports", members: 143, active: true, hue: "0", emoji: "♞", lastEvent: "6 days ago", founded: "2020", description: "Weekly blitz nights, inter-college leagues, opening prep clinics. Beginners always welcome.", banner: clubGradient("0") },
];
...
export interface Event {
  ...
  going: number;
  capacity: number;
  cover: string; // gradient token, always present, used as the background under photo (or alone as a fallback)
  photo?: string; // real theme-relevant photo; optional — falls back to the cover gradient when absent
  tags: string[];
  description: string;
...
export const events: Event[] = [
  { id: "e1", slug: "fusion-night-vi", title: "Fusion Night VI - Sarga Live", clubSlug: "sarga", club: "Sarga - Music Circle", date: "Sat, Jul 11", isoDate: "2026-07-11", time: "7:00 PM", venue: "Amphitheatre", status: "upcoming", going: 187, capacity: 300, cover: "linear-gradient(135deg,#7c3aed 0%,#ec4899 60%,#f97316 100%)", photo: "/club-events/fusion-night-vi.png", tags: ["Music", "Open"], description: "The sixth edition of Sarga's flagship fusion showcase. Six acts, one hour of chaos, one hour of soul. BYO glowsticks.", approval: "approved" },
  { id: "e2", slug: "cook-off-42", title: "Weekly Cook-Off #42", clubSlug: "codechef", club: "CodeChef IITM BS", date: "Sun, Jul 12", isoDate: "2026-07-12", time: "9:00 PM", venue: "Online · Discord", status: "upcoming", going: 218, capacity: 500, cover: "linear-gradient(135deg,#d4ff3a 0%,#22d3ee 100%)", photo: "/club-events/cook-off-42.png", tags: ["Contest", "Online"], description: "Four problems, two hours, one leaderboard. Editorial released 10 minutes after end. Top 5 get merch.", approval: "not-required" },
  { id: "e3", slug: "ignite-2026", title: "Ignite 2026 - Startup Weekend", clubSlug: "e-cell", club: "E-Cell IITM BS", date: "Fri–Sun, Jul 17–19", isoDate: "2026-07-17", time: "All day", venue: "IITM Research Park", status: "upcoming", going: 96, capacity: 120, cover: "linear-gradient(135deg,#fb923c 0%,#f43f5e 100%)", photo: "/club-events/ignite-2026.png", tags: ["Flagship", "Sponsored"], description: "54 hours. Idea → prototype → pitch. Ten mentors, five judges, one grand prize. Faculty sign-off in progress.", approval: "pending" },
  { id: "e4", slug: "bp-open-round", title: "BP Open Round · Paradox", clubSlug: "paradox", club: "Paradox - Debate Society", date: "Tue, Jul 14", isoDate: "2026-07-14", time: "6:30 PM", venue: "Seminar Hall 3", status: "upcoming", going: 42, capacity: 60, cover: "linear-gradient(135deg,#ff4d8f 0%,#a855f7 100%)", photo: "/club-events/bp-open-round.png", tags: ["Debate"], description: "British Parliamentary format. Motions announced 15 minutes before each round. First-timers get partnered with seniors.", approval: "approved" },
  { id: "e5", slug: "portfolio-crit", title: "Portfolio Crit Night", clubSlug: "kalakriti", club: "Kalakriti Design Guild", date: "Wed, Jul 15", isoDate: "2026-07-15", time: "8:00 PM", venue: "Studio B · Online hybrid", status: "upcoming", going: 31, capacity: 50, cover: "linear-gradient(135deg,#eab308 0%,#84cc16 100%)", photo: "/club-events/portfolio-crit.png", tags: ["Design", "Hybrid"], description: "Bring three screens or one case study. Ten-minute slots, brutally honest, brutally kind.", approval: "approved" },
  ...
  { id: "e9", slug: "zine-launch-night", title: "Zine Launch Night · Quill", clubSlug: "quill", club: "Quill - Writers' Circle", date: "Fri, Jul 18", isoDate: "2026-07-18", time: "6:00 PM", venue: "Library Courtyard", status: "upcoming", going: 22, capacity: 60, cover: "linear-gradient(135deg,#a855f7 0%,#ec4899 100%)", tags: ["Literary", "Open"], description: "Launch of the summer zine, print copies handed out at the door. Off-campus vendor for printing, needs faculty sign-off.", approval: "pending" },
  { id: "e10", slug: "inter-college-chess-meet", title: "Inter-College Chess Meet · Arena", clubSlug: "arena", club: "Arena - Chess Club", date: "Sat, Jul 19", isoDate: "2026-07-19", time: "10:00 AM", venue: "Off-campus · Chennai", status: "upcoming", going: 18, capacity: 30, cover: "linear-gradient(135deg,#334155 0%,#0f172a 100%)", tags: ["Sports", "Travel"], description: "Away fixture against three other campuses. Bus transport and away-day insurance need faculty approval before booking.", approval: "pending" },
  { id: "e11", slug: "annual-photo-exhibition", title: "Annual Photo Exhibition", clubSlug: "kalakriti", club: "Kalakriti Design Guild", date: "Mon, Jun 2", isoDate: "2026-06-02", time: "10:00 AM", venue: "Gallery Hall", status: "past", going: 64, capacity: 80, cover: "linear-gradient(135deg,#eab308 0%,#0ea5e9 100%)", tags: ["Design", "Exhibition"], description: "Semester showcase of member work. Volunteers handled setup, wall labels, and teardown.", approval: "not-required" },
];
...
export const tasks: Task[] = [
  ...
  { id: "t5", title: "Set up registration desk - Ignite", event: "Ignite 2026", role: "Logistics", due: "Fri 8 AM", dueAt: "2026-07-17T08:00:00", status: "todo", priority: "Med", assignee: "Vikram Shah" },
  { id: "t6", title: "Coordinate sponsor booth setup", event: "Ignite 2026", role: "Logistics", due: "Fri 9 AM", dueAt: "2026-07-17T09:00:00", status: "todo", priority: "Med", assignee: "Sneha Pillai" },
  { id: "t7", title: "Brief judges on scoring rubric", event: "Ignite 2026", role: "Coordination", due: "Sat 2 PM", dueAt: "2026-07-18T14:00:00", status: "doing", priority: "High", assignee: "Arjun Verma" },
  { id: "t8", title: "Print participant name badges", event: "Ignite 2026", role: "Logistics", due: "Done", dueAt: "2026-07-16T18:00:00", status: "done", priority: "Low", assignee: "Priya Ramesh" },
];
