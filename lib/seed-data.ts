...
export const events: Event[] = [
  { id: "e1", slug: "fusion-night-vi", title: "Fusion Night VI — Sarga Live", clubSlug: "sarga", club: "Sarga — Music Circle", date: "Sat, Jul 11", isoDate: "2026-07-11", time: "7:00 PM", venue: "Amphitheatre", status: "upcoming", going: 187, capacity: 300, cover: "linear-gradient(135deg,#7c3aed 0%,#ec4899 60%,#f97316 100%)", tags: ["Music", "Open"], description: "The sixth edition of Sarga's flagship fusion showcase. Six acts, one hour of chaos, one hour of soul. BYO glowsticks.", approval: "approved" },
  { id: "e2", slug: "cook-off-42", title: "Weekly Cook-Off #42", clubSlug: "codechef", club: "CodeChef IITM BS", date: "Sun, Jul 12", isoDate: "2026-07-12", time: "9:00 PM", venue: "Online · Discord", status: "upcoming", going: 218, capacity: 500, cover: "linear-gradient(135deg,#d4ff3a 0%,#22d3ee 100%)", tags: ["Contest", "Online"], description: "Four problems, two hours, one leaderboard. Editorial released 10 minutes after end. Top 5 get merch.", approval: "not-required" },
  { id: "e3", slug: "ignite-2026", title: "Ignite 2026 — Startup Weekend", clubSlug: "e-cell", club: "E-Cell IITM BS", date: "Fri–Sun, Jul 17–19", isoDate: "2026-07-17", time: "All day", venue: "IITM Research Park", status: "upcoming", going: 96, capacity: 120, cover: "linear-gradient(135deg,#fb923c 0%,#f43f5e 100%)", tags: ["Flagship", "Sponsored"], description: "54 hours. Idea → prototype → pitch. Ten mentors, five judges, one grand prize. Faculty sign-off in progress.", approval: "pending" },
  { id: "e4", slug: "bp-open-round", title: "BP Open Round · Paradox", clubSlug: "paradox", club: "Paradox — Debate Society", date: "Tue, Jul 14", isoDate: "2026-07-14", time: "6:30 PM", venue: "Seminar Hall 3", status: "upcoming", going: 42, capacity: 60, cover: "linear-gradient(135deg,#ff4d8f 0%,#a855f7 100%)", tags: ["Debate"], description: "British Parliamentary format. Motions announced 15 minutes before each round. First-timers get partnered with seniors.", approval: "approved" },
  { id: "e5", slug: "portfolio-crit", title: "Portfolio Crit Night", clubSlug: "kalakriti", club: "Kalakriti Design Guild", date: "Wed, Jul 15", isoDate: "2026-07-15", time: "8:00 PM", venue: "Studio B · Online hybrid", status: "upcoming", going: 31, capacity: 50, cover: "linear-gradient(135deg,#eab308 0%,#84cc16 100%)", tags: ["Design", "Hybrid"], description: "Bring three screens or one case study. Ten-minute slots, brutally honest, brutally kind.", approval: "approved" },
  { id: "e6", slug: "climate-teach-in", title: "Climate Teach-In · Local Schools", clubSlug: "prakriti", club: "Prakriti — Sustainability", date: "Thu, Jul 16", isoDate: "2026-07-16", time: "10:00 AM", venue: "Off-campus · Adyar", status: "upcoming", going: 24, capacity: 40, cover: "linear-gradient(135deg,#22c55e 0%,#0891b2 100%)", tags: ["Volunteer"], description: "Half-day teach-in at two neighborhood schools. Materials provided. Volunteers get transport reimbursement.", approval: "approved" },
  { id: "e7", slug: "chess-blitz-x", title: "Chess Blitz X · Arena", clubSlug: "arena", club: "Arena — Chess Club", date: "Sat, Jul 4", isoDate: "2026-07-04", time: "5:00 PM", venue: "Common Room", status: "past", going: 78, capacity: 80, cover: "linear-gradient(135deg,#334155 0%,#0f172a 100%)", tags: ["Sports"], description: "Nine rounds, 3+2 time control. Won by third-year Aarav Sen on tiebreaks.", approval: "not-required" },
  { id: "e8", slug: "sarga-open-jam", title: "Sarga Open Jam — June", clubSlug: "sarga", club: "Sarga — Music Circle", date: "Fri, Jun 27", isoDate: "2026-06-27", time: "7:30 PM", venue: "Amphitheatre", status: "past", going: 143, capacity: 150, cover: "linear-gradient(135deg,#7c3aed 0%,#ec4899 100%)", tags: ["Music"], description: "Twelve acts, one open mic. Recording available on the club drive.", approval: "not-required" },
];
