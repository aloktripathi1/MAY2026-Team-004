...
const EVENTS: EventSpec[] = [
  ...
  { clubSlug: "kalakriti", title: "UI/UX Bootcamp Weekend", status: "past", venue: "Seminar Hall 1", going: 65, capacity: 70, daysOffset: -35, approval: "not-required", tags: ["Design", "Workshop"], description: "Two-day intensive: heuristics, wireframes, and a live redesign critique.", photo: `${BLOB}/club-events/portfolio-crit.png` },
  ...
  { clubSlug: "kalakriti", title: "Illustration Sprint: Campus Stories", status: "upcoming", venue: "Seminar Hall 3", going: 25, capacity: 50, daysOffset: 8, approval: "approved", tags: ["Design", "Sprint"], description: "A day-long illustration sprint documenting campus life, exhibited the following week.", photo: `${BLOB}/club-events/portfolio-crit.png` },
  // ---- Prakriti Sustainability ----
  { clubSlug: "prakriti", title: "Campus Waste Audit Drive", status: "past", venue: "Meet at Main Gate", going: 40, capacity: 45, daysOffset: -25, approval: "not-required", tags: ["Volunteer"], description: "Full-campus waste segregation audit, findings compiled into a report for facilities.", photo: `${BLOB}/club-events/climate-teach-in.png` },
  { clubSlug: "prakriti", title: "Climate Action Panel", status: "past", venue: "Seminar Hall 1", going: 70, capacity: 75, daysOffset: -15, approval: "not-required", tags: ["Panel"], description: "Panel discussion with campus sustainability office and two alumni founders.", photo: `${BLOB}/club-events/climate-teach-in.png` },
  ...
  { clubSlug: "prakriti", title: "Sustainability Fair", status: "upcoming", venue: "OAT", going: 0, capacity: 150, daysOffset: 20, approval: "pending", tags: ["Fair"], description: "Stalls, workshops, and a repair cafe — campus-wide sustainability showcase.", photo: `${BLOB}/club-events/climate-teach-in.png` },
  // ---- E-Cell IITM BS ----
  { clubSlug: "e-cell", title: "Founder Circle: Fundraising 101", status: "past", venue: "Seminar Hall 2", going: 60, capacity: 65, daysOffset: -28, approval: "not-required", tags: ["Founders"], description: "Alumni founder walks through a real pitch deck and term sheet, Q&A after.", photo: `${BLOB}/club-events/ignite-2026.png` },
  ...
  { clubSlug: "e-cell", title: "Pitch Practice Fridays #9", status: "past", venue: "Online · Zoom", going: 35, capacity: 40, daysOffset: -10, approval: "not-required", tags: ["Practice"], description: "Rapid-fire two-minute pitch practice with peer feedback.", photo: `${BLOB}/club-events/ignite-2026.png` },
  ...
  { clubSlug: "e-cell", title: "Founder AMA: Series A Lessons", status: "upcoming", venue: "Seminar Hall 1", going: 0, capacity: 80, daysOffset: 25, approval: "pending", tags: ["Founders", "AMA"], description: "An alumna founder on what actually broke during her Series A, ask-anything format.", photo: `${BLOB}/club-events/ignite-2026.png` },
  // ---- Quill Writers' Circle ----
  { clubSlug: "quill", title: "Poetry Slam: Monsoon Verses", status: "past", venue: "Amphitheatre", going: 50, capacity: 55, daysOffset: -70, approval: "not-required", tags: ["Poetry"], description: "Open poetry slam, five-minute slots, judged by audience applause meter.", photo: undefined },
  { clubSlug: "quill", title: "Writing Sprint Saturday", status: "past", venue: "Seminar Hall 3", going: 22, capacity: 25, daysOffset: -55, approval: "not-required", tags: ["Sprint"], description: "Silent-writing sprints in 25-minute blocks, share-out at the end.", photo: undefined },
  { clubSlug: "quill", title: "Longform Critique Circle #7", status: "upcoming", venue: "Seminar Hall 2", going: 18, capacity: 30, daysOffset: 35, approval: "approved", tags: ["Critique"], description: "Essay-length pieces workshopped in small groups, written feedback required in advance.", photo: undefined },
  { clubSlug: "quill", title: "Campus Anthology Launch", status: "upcoming", venue: "OAT", going: 0, capacity: 80, daysOffset: 45, approval: "pending", tags: ["Launch"], description: "Launch reading for this year's campus anthology, contributors read excerpts.", photo: undefined },
  // ---- Arena Chess Club ----
