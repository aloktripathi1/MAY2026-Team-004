    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
          <div className="night-panel w-full max-w-lg rounded-2xl border border-white/10 p-6 shadow-2xl">
            <h2 className="mb-5 text-xl font-bold text-white">Edit event details</h2>
